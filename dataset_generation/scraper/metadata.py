...
def extract_department(url: str) -> str:
    ...
    dept_patterns = [
        (r"/cse/|/computer-science/", "Computer Science & Engineering"),
        (r"/electrical/|/ee/", "Electrical Engineering"),
        (r"/mechanical/|/me/", "Mechanical Engineering"),
        (r"/civil/|/ce/", "Civil & Infrastructure Engineering"),
        (r"/chemical-engineering/", "Chemical Engineering"),
        (r"/chemistry/", "Chemistry"),
        (r"/physics/", "Physics"),
        (r"/mathematics/", "Mathematics"),
        (r"/bioscience/", "Bioscience & Bioengineering"),
        (r"/metallurgical/", "Metallurgical & Materials Engineering"),
        (r"/school-of-artificial-intelligence/|/aide/", "School of AI & Data Science"),
        (r"/school-of-design/", "School of Design"),
        (r"/school-of-liberal-arts/|/sola/", "School of Liberal Arts"),
        (r"/school-of-management/|/sme/|/schools/", "School of Management & Entrepreneurship"),
